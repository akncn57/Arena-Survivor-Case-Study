...
| `ArenaSurvivor.Editor` | `Assets/Scripts/Editor` | Editör araçları: klip pişirme, Endless kurulumu | Core, Unity, uGUI, TextMeshPro |
...
Telefondaki sonuç (`PERFORMANCE.tr.md` > Adım 6): CPU ana thread 9,9 ms -> 7,8-8,4 ms, bellek 4-5 MB daha az.
...
Telefondaki sonuç: GPU süresi 13,2 -> 11,7 ms (`PERFORMANCE.tr.md` > Adım 7).
