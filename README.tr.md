...
- **Video:** [YouTube'da oynanış](https://youtu.be/Pc0BnKdYbnM)
...
| Unity MCP ile uçtan uca bir görev | Sahne, UI, Animator controller'lar ve bir optimizasyon adımı MCP ile yapıldı ve doğrulandı; bkz. [AI çalışma günlüğü](Docs/AI_WORKLOG.tr.md) |
...
[Docs/PERFORMANCE.tr.md](Docs/PERFORMANCE.tr.md) (ham JSON sonuçları `Docs/Benchmarks` altında).
...
Ayrıntılar ve her kararın gerekçesi: [Docs/TECH.tr.md](Docs/TECH.tr.md) > Optimize asset'ler.
...
| Dosya | İçerik |
|------|------|
| [Docs/TECH.tr.md](Docs/TECH.tr.md) | Her sistemin nasıl çalıştığı ve neden öyle yapıldığı |
| [Docs/PERFORMANCE.tr.md](Docs/PERFORMANCE.tr.md) | Referans ve optimize ölçümleri, adım adım |
| [Docs/AI_WORKLOG.tr.md](Docs/AI_WORKLOG.tr.md) | AI ile çalışma günlüğü: 3 kritik karar, MCP görevi, AI'ın hataları |

Bütün dökümanların İngilizce sürümü de var (uzantısında `.tr` olmayan dosyalar, varsayılan).
